...
class Kreuzcrawl < Formula
  ...
  homepage 'https://github.com/xberg-io/kreuzcrawl'
  url 'https://github.com/xberg-io/kreuzcrawl/archive/v0.3.0.tar.gz'
  sha256 'c4616ffca67162a4f562c8d0bb50e6a28832dd58a8903ab2730a555792e47e54'
  license 'Elastic-2.0'

  bottle do
    root_url "https://github.com/xberg-io/kreuzcrawl/releases/download/v0.3.0"
  ...
  head 'https://github.com/xberg-io/kreuzcrawl.git', branch: 'main'
