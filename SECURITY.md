...
This repository holds Homebrew formulae. The security-relevant surface is **distribution integrity**: a formula pointing at an unexpected URL, a missing or wrong `sha256`, or an install step running unreviewed remote content. Report anything that lets a user install something other than the intended artifact.
